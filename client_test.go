...
func init() {
	client = NewClient("http://137.220.194.113:17317", "mRuaqOYI2TxdWyx3DLCp6Y7HGzhwDZIc", 1*time.Second)
...
func TestClient_Upload(t *testing.T) {
	err := client.FileUpload("/www/wwwroot", "sunat_test12.apk", "/Users/anohana/Downloads/sunat_test.apk")
	if err != nil {
		fmt.Println(err)
		t.Fail()
	}
